    ...
    return <div className="flex justify-center m-40">
        <div >
            ...
            <div className="flex justify-center">
                <button className="m-14 bg-slate-50 text-slate-600 font-bold w-52 h-10 rounded-lg hover:bg-slate-100 text-2xl" onClick={()=>{router.push("/Pharase")}}>Create Wallet</button>
            </div>
        </div>
    </div>
}